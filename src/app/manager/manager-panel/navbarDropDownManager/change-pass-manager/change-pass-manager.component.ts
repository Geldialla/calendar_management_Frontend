...
@Component({
  selector: 'app-change-pass-manager',
  templateUrl: './change-pass-manager.component.html',
  styleUrls: ['./change-pass-manager.component.css']
})
export class ChangePassManagerComponent implements OnInit {
